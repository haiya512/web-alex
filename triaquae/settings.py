# Django settings for TriAquae project.
import os,sys
from backend import tri_config
#SITE_ROOT='/usr/local/src/triWeb_frontend/TriAquae'
SITE_ROOT = PATH = os.path.abspath(os.path.dirname(__file__))
import backend.tri_module
...
SECRET_KEY = 'dkc*q(qv5+8uc_!&0#0fd2thbc_+(qwou#icho%$p2z1!@u&8b'
...
ROOT_URLCONF = 'TriAquae.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'TriAquae.wsgi.application'
...
#)
#
#AUTH_LDAP_SERVER_URI = 'ldap://192.168.8.128'
