...
def posix_shell(chan,django_loginuser,hostname):
	...
	record_dic = {}
        ...
        f = open('%s/web/logs/audit_%s_%s.log' % (triaquae_path,day_time,django_loginuser),'a')
        d = open('%s/web/logs/detail_%s_%s.log' % (triaquae_path,day_time,django_loginuser),'a')
        while True:
