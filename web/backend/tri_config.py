...
RRDTOOL_png_dir = '%s/web/static/img/rrdtool_png/' %  Working_dir
RRDTOOL_rrd_file_dir= '%s/rrdtool/rrd_files' % Working_dir

MySQL_Name = 'web'   # Don't change this database name
...
Log_dir = '%s/web/logs' % Working_dir
Snmp_temp_log = '%s/snmp_temp.log' % Log_dir

Tri_IP = '127.0.0.1'  # Change it to your own IP address
Tri_Port = '4200'      # render device
Tri_connector_username = 'tri_connector'
Tri_connector_password = 'tripass'
Tri_connector_baoleiuser = '%s/web/backend/baoleiuser.py' % Working_dir
Tri_connector_baoleihost = '%s/web/backend/baoleihost.py' % Working_dir
